...
class test_circuit(unittest.TestCase):
    ...
    def test_setSolver(self):
        ...
        self.assertEqual(ckt4.write_to_CNF_file("Vgat",0)[1], [x,x,x])      #V
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Vgat",1)[1], [0,x,x])      #V
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Ugat",0)[1], [x,x,x])      #U
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Ugat",1)[1], [1,x,x])      #U
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Tgat",0)[1], [x,x,x])      #T
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Tgat",1)[1], [1,x,x])      #T
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["T1gat","Tgat"],0)[1], [x,x,x])      #T1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["T1gat","Tgat"],1)[1], [1,x,x])      #T1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["T2gat","Tgat"],0)[1], [x,x,x])      #T2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["T2gat","Tgat"],1)[1], [x,x,x])      #T2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["T3gat","Tgat"],0)[1], [x,x,x])      #T3
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["T3gat","Tgat"],1)[1], [x,x,x])      #T3
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Rgat",0)[1], [x,x,x])      #R
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Rgat",1)[1], [x,x,x])      #R
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Qgat",0)[1], [x,x,x])      #Q
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Qgat",1)[1], [x,x,x])      #Q
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Ngat",0)[1], [x,x,x])      #N
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Ngat",1)[1], [x,x,x])      #N
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["N1gat","Ngat"],0)[1], [x,x,x])      #N1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["N1gat","Ngat"],1)[1], [1,x,x])      #N1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["N2gat","Ngat"],0)[1], [x,x,x])      #N2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["N2gat","Ngat"],1)[1], [x,x,x])      #N2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Lgat",0)[1], [x,x,x])      #L
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Lgat",1)[1], [1,x,x])      #L
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["L1gat","Lgat"],0)[1], [x,x,x])      #L1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["L1gat","Lgat"],1)[1], [1,x,x])      #L1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["L2gat","Lgat"],0)[1], [x,x,x])      #L2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["L2gat","Lgat"],1)[1], [x,x,x])      #L2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["L3gat","Lgat"],0)[1], [x,x,x])      #L3
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["L3gat","Lgat"],1)[1], [x,x,x])      #L3
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("CIgat",0)[1], [x,x,x])      #CI
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("CIgat",1)[1], [x,x,x])      #CI
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["CI1gat","CIgat"],0)[1], [x,x,x])      #CI1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["CI1gat","CIgat"],1)[1], [1,x,x])      #CI1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["CI2gat","CIgat"],0)[1], [x,x,x])      #CI2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["CI2gat","CIgat"],1)[1], [x,x,x])      #CI2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Ygat",0)[1], [x,x,x])      #Y
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Ygat",1)[1], [x,x,x])      #Y
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["Y1gat","Ygat"],0)[1], [x,x,x])      #Y1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["Y1gat","Ygat"],1)[1], [1,x,x])      #Y1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["Y2gat","Ygat"],0)[1], [x,x,x])      #Y2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["Y2gat","Ygat"],1)[1], [x,x,x])      #Y2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Xgat",0)[1], [x,x,x])      #X
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file("Xgat",1)[1], [x,x,x])      #X
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["X1gat","Xgat"],0)[1], [x,x,x])      #X1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["X1gat","Xgat"],1)[1], [1,x,x])      #X1
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["X2gat","Xgat"],0)[1], [x,x,x])      #X2
        print ("----------------------------------------\n========================================")

        self.assertEqual(ckt4.write_to_CNF_file(["X2gat","Xgat"],1)[1], [x,x,x])      #X2
        print ("----------------------------------------\n========================================")
